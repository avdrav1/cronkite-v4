          ...
          <ScrollArea className="h-full w-full">
            <div className="flex flex-col pb-20 pt-20 px-6 md:px-12 max-w-3xl mx-auto">
              ...
              {article.imageUrl && (
                 ...
                 >
                   <img src={article.imageUrl} className="w-full h-full object-cover" alt="Article Hero" />
                 </motion.div>
              )}
              ...
              <div className="space-y-4 mb-8">
                 <div className="flex flex-wrap items-center gap-3 text-sm">
                   ...
                   <span className="text-muted-foreground font-mono">{format(new Date(article.date), "MMMM d, yyyy")}</span>
                   <span className="text-muted-foreground">•</span>
                   <span className="text-muted-foreground font-mono">{article.readTime} min read</span>
                 </div>
              ...
              <div className="flex justify-center">
                 <Button size="lg" className="rounded-full px-8 shadow-lg hover:shadow-primary/25 transition-all" asChild>
                   <a href="#" target="_blank">
                     Read Original on {article.source} <ExternalLink className="ml-2 h-4 w-4" />
                   </a>
                 </Button>
              </div>
            </div>
